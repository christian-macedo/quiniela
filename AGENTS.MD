...
8. Database & schema (`bootstrap.sql` updates, transactions for multi-step ops)
...
└── references → supabase/bootstrap.sql
...
| Bootstrap a fresh database                                | Follow **CLAUDE.md** → Database Bootstrap section                    |
